...
class SampleBase(object):
    def __init__(self, rows=16, brightness=50, chain=1, scan_mode=1, lsb=130, slow_down=1):
        ...
        #self.parser.add_argument("-b", "--led-brightness", action="store", help="Sets brightness level. Default: 100. Range: 1..100", default=25,type=int)
    ...
    def process(self):
        ...
        options.pwm_lsb_nanoseconds = self.lsb
        #if self.args.led_show_refresh:
          #options.show_refresh_rate = 1

        if self.slow_down != None:
            options.gpio_slowdown = self.slow_down
